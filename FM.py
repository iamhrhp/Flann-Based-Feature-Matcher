...
def load_input():
    input_image = cv2.imread('Harrypotter.jpg')
...
if __name__ == '__main__':
    ...
    # Getting Informations form the Input image
    ...
    while (ret):
        ...
        # Condition Check for error escaping (MIN_MATCHES=5000)
        ...
        # Computing and matching the Keypoints of Input & query Image
